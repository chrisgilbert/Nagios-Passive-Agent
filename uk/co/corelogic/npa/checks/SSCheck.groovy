...
public init() {
    ...
    */
    public registerChecks() {
        CheckRegister.add("chk_blocking_procs", "SS", this.getClass().getName())
    }


    public chk_blocking_procs(){
        init()
        ...
        def performance = ["SS_NUM_BLOCKING_PROCS":value]
    ...
    public chk_data_file_free() {
        init()

        assert this.chk_args.nagiosServiceName != null, "nagiosServiceName is a required parameter!"
        assert this.chk_args.unit_type != null, "unit_type is a required parameter!"
        ...
        def performance = ["SS_DATA_FILES_PCT_USED":pct_used, "SS_DATA_FILES_FREE":free, "SS_DATA_FILES_USED":used, "SS_DATA_FILES_FREE":total]
